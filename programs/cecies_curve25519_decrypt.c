...
int main(const int argc, const char* argv[])
{
    ...
    memset(&private_key, 0x00, sizeof(cecies_curve25519_key));
    ...
    int r = cecies_curve25519_decrypt((unsigned char*)message, message_len, true, private_key, o, message_len, &olen);
    if (r != 0)
    {
