 ...
 */
CECIES_API int cecies_curve25519_decrypt(const unsigned char* encrypted_data, size_t encrypted_data_length, bool encrypted_data_base64, cecies_curve25519_key private_key, unsigned char* output, size_t output_bufsize, size_t* output_length);
 ...
 * @return <c>0</c> if decryption succeeded; error codes as defined inside the header file or MbedTLS otherwise.
 */
CECIES_API int cecies_curve448_decrypt(const unsigned char* encrypted_data, size_t encrypted_data_length, bool encrypted_data_base64, cecies_curve448_key private_key, unsigned char* output, size_t output_bufsize, size_t* output_length);
